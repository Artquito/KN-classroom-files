...
print("Good luck player! and In any case, let's start the match!\n")
...
while end != True:
    ...
    while AnswerCheck != True:
        ...
        if answer == 0 or answer == 1 or answer == 2:
            ...
            if results == "win":
                print(f"your enemy played, {enemySelection}.")
                print("You WIN! Congratulations!")
                end = True
            elif results == "tie":
                print(f"your enemy played {enemySelection} as well, and so..")
